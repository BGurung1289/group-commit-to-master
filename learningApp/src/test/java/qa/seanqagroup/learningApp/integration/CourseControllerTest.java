...
public class CourseControllerTest {
	...
	public void addCourseTest() throws Exception {
		mvc.perform(MockMvcRequestBuilders.post("/course/add").contentType(MediaType.APPLICATION_FORM_URLENCODED)
				.content("{\"courseName\":\"Learn to control your inner Chi\", \"courseDescription\": \"To control your chi\", \"madeByTrainerid\": 1}")
//				.param("courseName", "Learn to control your inner Chi")
//				.param("courseDescription", "We teach you to control chi")
//				.param("madeByTrainerId", "1")
				)
